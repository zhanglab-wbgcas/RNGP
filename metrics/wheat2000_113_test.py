...
model_path = '../trainer_model.pth'
pheno_data = pd.read_csv('../wheat2000_pheno.txt',header=0)
...
heads = 1
for i in range(50):
    x_data, x_test, y_data, y_test = train_test_split(snp_data, pheno_data, test_size=3/5, random_state=i)
    x_train, x_val, y_train, y_val = train_test_split(x_data, y_data, test_size=1/2, random_state=i)
